                     ...
                     //   String firstName = jObj.getString("firstname");
                      //  String surname = jObj.getString("surname");
                        ...
                        //for(int i=0;i<jTask.length();i++) {
                            t = new Tasks(jTask.getJSONObject(0).getString("name"), jTask.getJSONObject(0).getString("shortDescription"), jTask.getJSONObject(0).getString("fullDescription"), jTask.getJSONObject(0).getString("startTime"), jTask.getJSONObject(0).getString("endTime"), jTask.getJSONObject(0).getInt("salary"), jTask.getJSONObject(0).getInt("closed"), jTask.getJSONObject(0).getString("created_by"));
                        //}
