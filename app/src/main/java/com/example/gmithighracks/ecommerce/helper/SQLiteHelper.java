   ...
   // private static final String KEY_UID = "uid";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_LOGIN + "("
                 + KEY_USERNAME + " TEXT PRIMARY KEY," + KEY_FIRST_NAME + " TEXT" + KEY_SURNAME + " TEXT"
     ...
     * */
    public void addUser(String username, String firstName, String surname, String email, String usertype) {
        ...
        values.put(KEY_TYPE, usertype);// Email
